...
export const LOYALTY_SCENARIOS = [
  {
    id:"conservative",
    l:{ az:"Konservativ", en:"Conservative", ru:"Консервативный" },
    s:{ az:"%5 at-risk → loyal", en:"5% at-risk → loyal", ru:"5% at-risk → лояльные" },
    e:772, r:11912,
    newReturners:386, extraVisits:772, addRevenue:14802, cost:2890, net:11912,
  },
  {
    id:"realistic",
    l:{ az:"Real", en:"Realistic", ru:"Реалистичный" },
    s:{ az:"%10 at-risk → loyal", en:"10% at-risk → loyal", ru:"10% at-risk → лояльные" },
    e:1544, r:23824,
    newReturners:772, extraVisits:1544, addRevenue:29604, cost:5780, net:23824,
  },
  {
    id:"ambitious",
    l:{ az:"Ambisiyalı", en:"Ambitious", ru:"Амбициозный" },
    s:{ az:"%18 at-risk → loyal", en:"18% at-risk → loyal", ru:"18% at-risk → лояльные" },
    e:2780, r:42883,
